// Custom JavaScript for Semana 3 - Protocolos, Formatos y XML en Sistemas Distribuidos

// Initialize presentation when DOM is loaded
document.addEventListener('DOMContentLoaded', function () {
    console.log('Presentación Semana 3 - Protocolos, Formatos y XML en Sistemas Distribuidos cargada');
...
// Show protocols information
function showProtocolsInfo() {
    const protocolsInfoContent = `
        <div style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; 
                    background: rgba(0,0,0,0.8); z-index: 9999; display: flex; 
                    align-items: center; justify-content: center;" id="protocolsInfoOverlay">
            <div style="background: white; padding: 2rem; border-radius: 10px; max-width: 700px;">
                <h3>Guía Rápida de Protocolos y Formatos</h3>
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; text-align: left;">
                    <div>
                        <h4 style="color: #28a745;">Alto Rendimiento</h4>
                        <p><strong>gRPC:</strong> Serialización binaria, baja latencia</p>
                        <p><strong>HTTP/2:</strong> Multiplexación, compresión</p>
                        <p><strong>WebSockets:</strong> Conexión persistente</p>
                    </div>
                    <div>
                        <h4 style="color: #910048;">Formatos de Datos</h4>
                        <p><strong>Protobuf:</strong> Binario eficiente, evolución</p>
                        <p><strong>JSON:</strong> Simple, interoperable</p>
                        <p><strong>XML:</strong> Empresarial, semántico</p>
                    </div>
                </div>
                <div style="margin-top: 1rem;">
                    <h4 style="color: #23356E;">Criterios de Selección</h4>
                    <p><strong>Rendimiento crítico:</strong> gRPC + Protobuf</p>
                    <p><strong>Simplicidad:</strong> JSON + HTTP/REST</p>
                    <p><strong>Enterprise:</strong> XML + SOAP</p>
                </div>
                <button onclick="closeOverlay('protocolsInfoOverlay')" 
                        style="margin-top: 1rem; padding: 0.5rem 1rem; 
    ...
    document.body.insertAdjacentHTML('beforeend', protocolsInfoContent);
}
