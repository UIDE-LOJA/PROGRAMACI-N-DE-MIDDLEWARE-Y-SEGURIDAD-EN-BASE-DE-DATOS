...
// Declarar variables globales temprano para evitar errores de referencia
let startVacuumSimulationVar, resetVacuumSimulationVar, closeResultsModalVar;
...
function startVacuumSimulation() {
    return startVacuumSimulationInternal();
}

function resetVacuumSimulation() {
